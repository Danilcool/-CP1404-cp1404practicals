...
bigger_then_nine_number = [number for number in int_numbers if number > 9]
print(bigger_then_nine_number)
...
long_name = [f'{name.split(" ")[1]}' for name in full_names if len(name) > 11]
print(", ".join(long_name))
# or
long_name = ", ".join([f'{name.split(" ")[1]}' for name in full_names if len(name) > 11])
print(long_name)